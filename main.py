...
st.set_page_config(page_title="INDUSTRIAL COPPER MODELLING | SAMUNDEESWARI",
                   page_icon=icon,
                   layout="wide",
                   )
...
<div style='text-align:center'>
    <h1 style='color:#3385ff;'>Industrial Copper Modeling Application</h1>
</div>
...
with tab1:
    ...
    with right:
        ...
        st.write('#### CLASSIFICATION - ***:green[DECISION TREE CLASSIFIER]***')
        st.write(
            '- The decision tree classification is a distribution-free or non-parametric supervised learning method which does not depend upon probability distribution assumptions. Decision trees can handle high-dimensional data with good accuracy.')
...
with tab2:
    ...
    if submit_button and flag == 0:
        ...
        with open(r"C:\Users\samub\pythonProject5-Copper Modelling\model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r'C:\Users\samub\pythonProject5-Copper Modelling\scaler.pkl', 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"C:\Users\samub\pythonProject5-Copper Modelling\t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"C:\Users\samub\pythonProject5-Copper Modelling\s.pkl", 'rb') as f:
...
with tab3:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"C:\Users\samub\pythonProject5-Copper Modelling\cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r'C:\Users\samub\pythonProject5-Copper Modelling\cscaler.pkl', 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"C:\Users\samub\pythonProject5-Copper Modelling\ct.pkl", 'rb') as f:
...
st.write(f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by samundeeswari</h6>', unsafe_allow_html=True)
